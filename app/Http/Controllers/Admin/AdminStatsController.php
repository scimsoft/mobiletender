...
GROUP BY NAME');
        $ventaPorDias = DB::select('SELECT dayname( receipts.Datenew) as dayname,date ( receipts.Datenew) AS mdate, COUNT(DISTINCT(receipts.ID)) AS CHECKS, SUM(ticketlines.UNITS*ticketlines.PRiCE*1.1) AS TOTAL
