        ...
        <div class="row justify-content-center">
            <div class="">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="/web/products/simple" class="nav-link h5">Paquete Simple</a>
                        <h6>El cliente mediante la carta digital puede hacer su pedido, y recogerlo en su local. </h6>

                        <a href="/web/products/standard" class="nav-link h5">Paquete Estandard</a>
                        ...
                        <a href="/web/products/premium" class="nav-link h5">Paquete Premium</a>
                    ...
                    <table class="table text-justify">
                        <tr>
                            <td class="h4 text-center">BENEFICIOS ESTABLECIMIENTO</td>
                            <td></td>
                            <td class="h4 text-center">BENEFICIOS CLIENTES</td>
                        </tr>
                        <tr>
                            <td>
